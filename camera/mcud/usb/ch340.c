...
// gcc ch340.c `pkg-config libusb-1.0 --libs --cflags` -o usb
#include <errno.h>
#include <signal.h>
#include <string.h>
#include <stdio.h>
...
int send_to_uart(void)
{
    ...
    unsigned char sendbuf[] = "x00110adf";
    ...
    // } else {
        ...
        int transferred;
        r = libusb_bulk_transfer(devh, EP_DATA_OUT, sendbuf, sizeof(sendbuf), &transferred, 200);
        printf("transfered: %d", transferred);
...
int main(int argc, char **argv)
{
    ...
    printf("received char %s", (char*)recvbuf);
